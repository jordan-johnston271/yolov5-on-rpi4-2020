...
annotated_args = {
    ...
    torch._C._VariableFunctions.rowwise_prune: [{'name': 'weight', 'simple_type': 'Tensor'}, {'name': 'mask', 'simple_type': 'Tensor'}, {'name': 'compressed_indices_dtype', 'simple_type': 'ScalarType'}],
