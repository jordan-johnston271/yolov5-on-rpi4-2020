...
def _fft_c2c(input: Tensor, dim: _size, normalization: _int, forward: _bool) -> Tensor: ...
def _fft_c2r(input: Tensor, dim: _size, normalization: _int, last_dim_size: _int) -> Tensor: ...
def _fft_r2c(input: Tensor, dim: _size, normalization: _int, onesided: _bool) -> Tensor: ...
@overload
...
__all__ = ['__and__', '__lshift__', '__or__', '__rshift__', '__xor__', '_adaptive_avg_pool2d',
 ...
 '_fake_quantize_learnable_per_tensor_affine', '_fft_c2c', '_fft_c2r', '_fft_r2c', '_fft_with_size',
 ...
 '_foreach_trunc_', '_fused_dropout', '_grid_sampler_2d_cpu_fallback',
 ...
 '_syevd_helper', '_test_serialization_subcmul', '_trilinear', '_unique', '_unique2',
 '_use_cudnn_ctc_loss', '_use_cudnn_rnn_flatten_weight', '_validate_sparse_coo_tensor_args', '_var',
 '_weight_norm', '_weight_norm_cuda_interface', 'abs', 'abs_', 'absolute', 'acos', 'acos_', 'acosh',
 'acosh_', 'adaptive_avg_pool1d', 'adaptive_max_pool1d', 'add', 'addbmm', 'addcdiv', 'addcmul',
 'addmm', 'addmv', 'addmv_', 'addr', 'affine_grid_generator', 'all', 'allclose', 'alpha_dropout',
 ...
 'clamp_min', 'clamp_min_', 'clip', 'clip_', 'clone', 'column_stack', 'combinations', 'complex',
 'conj', 'constant_pad_nd', 'conv1d', 'conv2d', 'conv3d', 'conv_tbc', 'conv_transpose1d',
 'conv_transpose2d', 'conv_transpose3d', 'convolution', 'copysign', 'cos', 'cos_', 'cosh', 'cosh_',
 ...
 'flip', 'fliplr', 'flipud', 'float_power', 'floor', 'floor_', 'floor_divide', 'fmod', 'frac',
 'frac_', 'frobenius_norm', 'from_file', 'from_numpy', 'full', 'full_like', 'gather', 'gcd', 'gcd_',
 'ge', 'geqrf', 'ger', 'get_default_dtype', 'get_num_interop_threads', 'get_num_threads', 'greater',
 ...
 'hstack', 'hypot', 'i0', 'i0_', 'igamma', 'igammac', 'imag', 'index_add', 'index_copy',
 'index_fill', 'index_put', 'index_put_', 'index_select', 'init_num_threads', 'inner',
 'instance_norm', 'int_repr', 'inverse', 'is_complex', 'is_distributed', 'is_floating_point',
 'is_grad_enabled', 'is_nonzero', 'is_same_size', 'is_signed', 'is_vulkan_available', 'isclose',
 'isfinite', 'isinf', 'isnan', 'isneginf', 'isposinf', 'isreal', 'kaiser_window', 'kron',
 'kthvalue', 'layer_norm', 'lcm', 'lcm_', 'ldexp', 'ldexp_', 'le', 'lerp', 'less', 'less_equal',
 'lgamma', 'linspace', 'log', 'log10', 'log10_', 'log1p', 'log1p_', 'log2', 'log2_', 'log_',
 'log_softmax', 'logaddexp', 'logaddexp2', 'logcumsumexp', 'logdet', 'logical_and', 'logical_not',
 'logical_or', 'logical_xor', 'logit', 'logit_', 'logspace', 'logsumexp', 'lstm', 'lstm_cell',
 'lstsq', 'lt', 'lu_solve', 'masked_fill', 'masked_scatter', 'masked_select', 'matmul',
 'matrix_exp', 'matrix_power', 'matrix_rank', 'max', 'max_pool1d', 'max_pool1d_with_indices',
 'max_pool2d', 'max_pool3d', 'maximum', 'mean', 'median', 'min', 'minimum', 'miopen_batch_norm',
 ...
 'mkldnn_max_pool2d', 'mkldnn_max_pool3d', 'mm', 'mode', 'moveaxis', 'movedim', 'msort', 'mul',
 'multinomial', 'multiply', 'mv', 'mvlgamma', 'namedtuple_Q_R', 'namedtuple_U_S_V',
 'namedtuple_a_tau', 'namedtuple_eigenvalues_eigenvectors', 'namedtuple_sign_logabsdet',
 ...
 'row_stack', 'rowwise_prune', 'rrelu', 'rrelu_', 'rsqrt', 'rsqrt_', 'rsub', 'scalar_tensor',
 'scatter', 'scatter_add', 'searchsorted', 'select', 'selu', 'selu_', 'set_flush_denormal',
 ...
 'std_mean', 'sub', 'subtract', 'sum', 'svd', 'swapaxes', 'swapdims', 'symeig', 't', 'take', 'tan',
 'tan_', 'tanh', 'tanh_', 'tensor', 'tensor_split', 'threshold', 'threshold_', 'tile', 'topk',
